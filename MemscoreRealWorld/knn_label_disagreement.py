...
def calculate_knn_label_disagreement(
    ...
    """
    Calculate the kNN Label Disagreement metric for nodes in a graph dataset.
    ...
    Args:
        ...
        threshold: Memorization score threshold to classify nodes as memorized or not
        similarity_metric: Metric for finding nearest neighbors ('cosine', 'euclidean', etc.)
        ...
        logger: Logger for output information
        
    Returns:
        DataFrame containing node indices, memorization status, and kNN disagreement scores,
        Dictionary containing statistical test results and analysis metrics
    """
    if logger:
        logger.info("\nCalculating kNN Label Disagreement...")
...
def run_knn_label_disagreement_analysis(
    ...
    Args:
        ...
        similarity_metric: Metric for finding nearest neighbors
